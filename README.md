...
This project demonstrates how **Apache Kafka enables asynchronous, decoupled communication between microservices using an event-driven architecture**.

Key benefits of this approach:

| Benefit | Description |
|---|---|
| Loose Coupling | Services evolve independently without direct dependencies |
| High Scalability | Each service can be scaled horizontally as needed |
| Improved Reliability | Kafka retains events, preventing data loss on service failure |
| Better Performance | Asynchronous processing avoids blocking calls between services |
